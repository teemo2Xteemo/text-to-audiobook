...
MVP default: NLLB (CPU distilled). First optional LLM path: Ollama + TranslateGemma (ADR 0011) at `backend/app/providers/translation/ollama.py`. Later / other: LibreTranslate, OpenAI, Gemini.
