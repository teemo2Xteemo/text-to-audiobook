...
- [M14 Ollama TranslateGemma translation adapter](plans/m14-ollama-translation-adapter.md) — optional post-M13 provider (ADR 0011 / issue #12); contract pinned, adapter not on `main` yet
